...
type OiMomentumTab = "settings" | "optimizer" | "api";
...
export function BotsPage() {
  ...
  const [tab, setTab] = usePersistentState<OiMomentumTab>("oimomentum.tab", "settings");
          ...
          <Card.Body>
            {tab === "settings" ? (
              ...
              <ProviderCapabilitiesCard
                botId={OI_MOMENTUM_BOT_ID}
                title="OI Momentum endpoints availability"
